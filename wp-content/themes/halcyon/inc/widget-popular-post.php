...
// register Halcyon_Popular_Post widget
function halcyon_register_popular_post_widget() {
    register_widget( 'Halcyon_Popular_Post' );
}
add_action( 'widgets_init', 'halcyon_register_popular_post_widget' );
 
 /**
 * Adds Halcyon_Popular_Post widget.
 */
class Halcyon_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'halcyon_popular_post', // Base ID
			__( 'RARA: Popular Post', 'halcyon' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'halcyon' ), ) // Args
		);
	}
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? sanitize_text_field( $new_instance['title'] ) : __( 'Popular Posts', 'halcyon' );
